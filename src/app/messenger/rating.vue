        ...
        .pending(v-if="start")
            ...
            .one_of_list.mt(v-if="poll.Questions[index].Type === 'one_of_list'")
                .buttons-one-of-list.m-b(v-for="(answer, i) in poll.Questions[index].Answers",
                    ...
                    button.button.button_one_of_list(@click.prevent="setPollVariant(answer)", :class="{'button_active': answer.Id === pollResult[index].RatingPollAnswerId }")
                      | {{ answer.Text }}
            .fcr.mt(v-if="poll.Questions[index].Type === 'fcr'")
              .buttons-fcr.mt
                button.button.button_one_of_list(@click.prevent="setPollVariantFCR(poll.Questions[index].Answers[0])", :class="{'button_active': poll.Questions[index].Answers[0].Id === pollResult[index].RatingPollAnswerId}")
                    | {{ poll.Questions[index].Answers[0].Text }}
                button.button.button_one_of_list(@click.prevent="setPollVariantFCR(poll.Questions[index].Answers[1])", :class="{'button_active': poll.Questions[index].Answers[1].Id === pollResult[index].RatingPollAnswerId}")
