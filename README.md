...
- [IQChannels Widget](#iqchannels-widget)
...
* `handlers` ручки передачи callback'ов выполняющие разную логику
* `handlers.onLinkClick` функция, выполняющаяся при клике на любую ссылку в виджете, имеет сигнатуру:
> ```ts
